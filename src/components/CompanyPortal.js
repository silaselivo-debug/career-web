...
const CompanyPortal = ({ user, onLogout }) => {
  ...
  const renderPostJob = () => (
    <div>
      <h3 style={{ color: '#374151', marginBottom: '20px', fontSize: '1.25rem', fontWeight: 700 }}>Post Job</h3>
  ...
  const renderJobPostings = () => (
    <div>
      <h3 style={{ color: '#374151', marginBottom: '20px', fontSize: '1.25rem', fontWeight: 700 }}>Job Postings</h3>
      <p style={{ color: '#6b7280' }}>No job postings to display.</p>
    </div>
  );

  const renderApplicants = () => (
    <div>
      <h3 style={{ color: '#374151', marginBottom: '20px', fontSize: '1.25rem', fontWeight: 700 }}>Top Talent</h3>
      <p style={{ color: '#6b7280' }}>No applicants to display.</p>
    </div>
  );

  const renderJobApplications = () => (
    <div>
      <h3 style={{ color: '#374151', marginBottom: '20px', fontSize: '1.25rem', fontWeight: 700 }}>Applications</h3>
      <p style={{ color: '#6b7280' }}>No applications to review.</p>
    </div>
  );
